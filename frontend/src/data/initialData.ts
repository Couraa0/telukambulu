...
export interface UserAdmin {
  ...
  password?: string;
  nama: string;
  role: 'Super Admin' | 'Admin Konten' | 'Admin Pengaduan' | 'Admin Profil' | 'Viewer';
  aktif: boolean;
}
...
export const initialData: DesaDatabase = {
  ...
  "berita": [
    ...
    },
    {
      ...
      "kategori": "Wisata",
      "gambar": "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&q=80&w=800",
      "penulis": "Admin Konten",
      "tanggal": "2026-06-10",
      "views": 540,
      "status": "publish"
  ...
  "produk": [
    ...
    },
    {
      ...
      "foto": "https://images.unsplash.com/photo-1568254183919-78a4f43a2877?auto=format&fit=crop&q=80&w=600",
  ...
  "wisata": [
    {
      ...
      "foto": "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&q=80&w=600",
      ...
      "galeri": [
        "https://images.unsplash.com/photo-1604999333679-b86d54738315?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
      ...
      "galeri": [
        ...
        "https://images.unsplash.com/photo-1590001155093-a3c66ab0c3ff?auto=format&fit=crop&q=80&w=600"
      ]
    },
    {
      "id": 3,
